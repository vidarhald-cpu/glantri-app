...
- The editor uses two compact lines: an event line for Round and Description, then an effect line for Type, Group, location, damage, modifier, duration, status, and details.
